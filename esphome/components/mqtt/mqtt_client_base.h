...
class MqttClientBase {
 public:
  ...
  using on_message_callback_t = std::function<void(const char *topic, const char *payload,
  ...
  virtual void set_will(const char *topic, uint8_t qos, bool retain, const char *payload = nullptr, size_t length = 0) = 0;
